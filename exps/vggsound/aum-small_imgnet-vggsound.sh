...
imagenet_pretrain_path=/mnt/lynx2/users/mhamza/vim/official-ckpt/vim_s_midclstok_80p5acc.pth # Modify according to yours
...
exp_name=aum-small_imgnet-vggsound
